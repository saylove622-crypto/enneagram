...
**Neon Enneagram Orbit**는 Riso-Hudson 에니어그램 이론을 기반으로 인간 심리의 역동성을 3차원 공간에서 시각화한 인터랙티브 다이어그램입니다. '에너지 흐름'과 '회전하는 다이아몬드'를 메타포로 하여, 성격 유형 간의 복잡한 연결성과 심리적 변화를 세련된 네온 그래픽으로 표현합니다.
